...
We as members, contributors, and maintainers pledge to make participation in this project and our
...
If you need a private channel and no maintainer email is published, use one of these options:

- Contact the repository owner via the email (if any) listed on their GitHub profile, or
- Open an issue asking for a private contact method (do not include sensitive details), and a maintainer will follow up.
